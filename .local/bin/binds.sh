...
hyprctl keyword "$un"bind "SUPER SHIFT CTRL, mouse:272, pin"
hyprctl keyword "$un"bind "SUPER SHIFT ALT, mouse:272, togglesplit"
hyprctl keyword "$un"bind "SUPER CTRL ALT, mouse:272, moveoutofgroup"
hyprctl keyword "$un"bind "SUPER SHIFT CTRL ALT, mouse:272, togglegroup"
